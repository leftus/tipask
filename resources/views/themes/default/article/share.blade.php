...
<head>
	...
	.rateprt1{width: 56%;}
	.ratep1{font-size: 0.36rem;color:#252525;overflow: hidden;width:200px;height: 38px;text-overflow: ellipsis;white-space: nowrap}
	 ...
	 <div class="artpt1">
	 	...
	 	<div class="clearfix ad-rate" <?php echo $display;?>>
	 		...
	 		<div class="fl rateprt1">
	 			...
	 			<a href="<?php echo $advert->jump_url?>"><p class="ratep2"><?php echo $advert->descri;?></p></a>
	 		</div>
