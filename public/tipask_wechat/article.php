...
<head>
	...
	<style type="text/css">
		...
		.artpt1-p2{font-size: 0.35rem;color:#8c8c8c;line-height: 0.45rem;margin-top: 0.25rem;margin-bottom: 0.25rem;}
		 #news{font-size: 0.28rem;color:#3e3e3e;line-height: 0.55rem;margin: 0 auto;margin-top: 0.35rem;margin-bottom: 0.35rem;text-align: center;width: 82%;}
...
<body>
	 ...
	 <div class="artbtm clearfix">
	 	...
	 	<div class="fl">
	 		...
	 		<p class="artbtp2">迅速将您的生意传遍到全国&nbsp<a href="#" class="artbtp3">立即体验</a></p>
	 	</div>
